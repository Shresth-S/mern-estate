...
export default function CreateListinggg() {
  return (
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                      ...
                      <div className='flex items-center gap-2'>
                          <input type='number' id='bathroooms' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                          <p>Baths</p>
                      </div>
                      <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button className='p-3 bg-slate-700 text-white rounded-lg uppercase opacity-95 disabled:opacity-80'>Create Listing</button>
